...
import CCVisakhapatnamGasLeak from "../../charts_cross_correlation/Visakhapatnam_gas_leak.png";
...
function CC_Visakhapatnam_gas_leak() {
    return (
        <>
        <Header />
            ...
            <div className="col-md-4 sidebar">
                ...
                <div className="col-md-8">
                    <div className="card card-body pt-0">
                        <img src={CCVisakhapatnamGasLeak} width="700px" height="400px" />
                    </div>
                </div>
            </div>
        </div>
...
export default CC_Visakhapatnam_gas_leak;