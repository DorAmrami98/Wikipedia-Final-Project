...
import CC_COVID_19_pandemic from "../../charts_cross_correlation/COVID-19_pandemic_de_zh.png";
...
function CC_COVID_19_pandemic_de_zh() {
    return (
        <>
        <Header />
            ...
            <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center cc_covid_flags">
                            ...
                            <Link to="/cross-correlation-COVID_19_pandemic_de_zh" className="btn btn-sm btn-light cc_covid_flags_active">
...
export default CC_COVID_19_pandemic_de_zh;