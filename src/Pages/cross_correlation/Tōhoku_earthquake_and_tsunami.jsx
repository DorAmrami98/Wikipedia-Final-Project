...
import CCTohokuEarthquakeAndTsunami from "../../charts_cross_correlation/2011_Tōhoku_earthquake_and_tsunami.png";
...
function CC_Tohoku_earthquake_and_tsunami() {
    return (
        <>
        <Header />
            ...
            <div className="col-md-4 sidebar">
                ...
                <div className="col-md-8">
                    <div className="card card-body pt-0">
                        <img src={CCTohokuEarthquakeAndTsunami} width="700px" height="400px" />
                    </div>
                </div>
            </div>
        </div>
...
export default CC_Tohoku_earthquake_and_tsunami;