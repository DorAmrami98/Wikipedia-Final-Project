...
import CC_COVID_19_pandemic from "../../charts_cross_correlation/COVID-19_pandemic_fr_it.png";
...
function CC_COVID_19_pandemic_fr_it() {
    return (
        <>
        <Header />
            ...
            <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center cc_covid_flags">
                            ...
                            <Link to="/cross-correlation-COVID_19_pandemic_fr_it" className="btn btn-sm btn-light cc_covid_flags_active">
                                <img src={FR} className="flag_icon mr-1" />
                                <img src={IT} className="flag_icon" />
                            </Link>
...
export default CC_COVID_19_pandemic_fr_it;