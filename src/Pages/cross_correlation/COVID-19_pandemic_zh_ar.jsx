...
import CC_COVID_19_pandemic from "../../charts_cross_correlation/COVID-19_pandemic_zh_ar.png";
...
function CC_COVID_19_pandemic_zh_ar() {
    return (
        <>
        <Header />
...
export default CC_COVID_19_pandemic_zh_ar;