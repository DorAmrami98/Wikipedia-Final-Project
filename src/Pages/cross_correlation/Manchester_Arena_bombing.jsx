...
import CCManchesterArenabombing from "../../charts_cross_correlation/Manchester_Arena_bombing.png";
...
function CC_Manchester_Arena_bombing() {
    return (
        <>
        <Header />
            ...
            <div className="col-md-4 sidebar">
                ...
                <div className="col-md-8">
                    <div className="card card-body pt-0">
                        <img src={CCManchesterArenabombing} width="700px" height="400px" />
                    </div>
                </div>
            </div>
        </div>
...
export default CC_Manchester_Arena_bombing;