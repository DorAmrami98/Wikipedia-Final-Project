...
import CCAquilaEarthquake from "../../charts_cross_correlation/2009_L'Aquila_earthquake.png";
            ...
            <div className="row">
                ...
                <div className="col-md-8">
                    <div className="card card-body pt-0">
                        <img src={CCAquilaEarthquake} width="700px" height="400px" />
                    </div>
                </div>
            </div>
        </div>
...
export default CC_Aquila_earthquake;