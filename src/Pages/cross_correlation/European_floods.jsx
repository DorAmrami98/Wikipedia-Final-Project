...
import CCEuropean_floods from "../../charts_cross_correlation/2021_European_floods.png";
            ...
            <div className="col-md-4 sidebar">
                ...
                <div className="col-md-8">
                    <div className="card card-body pt-0">
                        <img src={CCEuropean_floods} width="700px" height="400px" />
                    </div>
                </div>
            </div>
        </div>
...
export default CC_European_floods;