...
function COVID_19_pandemic_fr() {
    ...
    const chartData = Object.entries(dataFR).map(([date, value]) => ({date, value}));
    let mergedData = [];
    for (let key in dataFR) {
        if (dataUS.hasOwnProperty(key) && dataDE.hasOwnProperty(key) && dataIT.hasOwnProperty(key) && dataCN.hasOwnProperty(key) && dataSA.hasOwnProperty(key)) {
            mergedData.push({
                date: key,
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center">
                            ...
                            <Link to="/covid_19_pandemic_fr"><img src={FR} className="flag_icon active_lang" /></Link>
                ...
                <div className="col-md-8">
                    ...
                    <div className="tab-content pt-2">
                        ...
                        <h5>Pandémie de Covid-19 <img src={FR} className="flag_icon" /></h5>
                        <small className="text-muted">Pandémie de Covid-19 - Total View</small>
                        </div>
...
export default COVID_19_pandemic_fr;