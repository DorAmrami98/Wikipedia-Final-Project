...
import ManchesterArenaBombingChart from "../charts_edits/Manchester_Arena_bombing.png";
...
function Manchester_Arena_bombing_sa() {
    ...
    useEffect(() => {
        async function fetchData() {
          ...
          setDataUS(jsonData.Views[2]);
          setDataSA(jsonData.Views[3]);
        }
        fetchData();
    }, []);
    const chartData = Object.entries(dataSA).map(([date, value]) => ({date, value}));
    let mergedData = [];
    for (let key in dataSA) {
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        <h5>قصف مانشستر أرينا</h5>
                        <div className="d-flex justify-content-center">
                            <Link to="/manchester_arena_bombing_en"><img src={US} className="flag_icon mr-3" /></Link>
                            <Link to="/manchester_arena_bombing_sa"><img src={SA} className="flag_icon active_lang" /></Link>
                        </div>
                    </div>
                    </Link>
                ...
                <div className="col-md-8">
                    ...
                    <div className="tab-content pt-2">
                        ...
                        <h5>قصف مانشستر أرينا <img src={SA} className="flag_icon" /></h5>
                        <small className="text-muted">قصف مانشستر أرينا - Total View</small>
                        </div>
                        ...
                        <div className="tab-pane fade" id="edits" role="tabpanel">
                            <img src={ManchesterArenaBombingChart} width="700px" height="400px" />
                        </div>
                        <div className="tab-pane fade" id="comparison" role="tabpanel">
                            <LineChart width={700} height={400} data={mergedData}>
                                ...
                                <Line type="monotone" dataKey="Arab" stroke="#199d00" activeDot={{ r: 8 }} />
                            </LineChart>
                        </div>
                    </div>
                    </div>
...
export default Manchester_Arena_bombing_sa;