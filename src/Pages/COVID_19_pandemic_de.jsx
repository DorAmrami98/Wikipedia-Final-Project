...
function COVID_19_pandemic_de() {
    ...
    for (let key in dataDE) {
        if (dataUS.hasOwnProperty(key) && dataFR.hasOwnProperty(key) && dataIT.hasOwnProperty(key) && dataCN.hasOwnProperty(key) && dataSA.hasOwnProperty(key)) {
            mergedData.push({
                date: key,
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center">
                            ...
                            <Link to="/covid_19_pandemic_de"><img src={DE} className="flag_icon mx-3 active_lang" /></Link>
                ...
                <div className="col-md-8">
                    ...
                    <div className="tab-content pt-2">
                        ...
                        <h5>COVID-19 Pandemie <img src={DE} className="flag_icon" /></h5>
                        <small className="text-muted">COVID-19 Pandemie - Total View</small>
                        </div>
...
export default COVID_19_pandemic_de;