...
import InondationsDChart from "../charts_edits/Aude_River_flooding.png";
...
function Inondations_d() {
    const [data, setData] = useState([]);
    useEffect(() => {
        async function fetchData() {
          const response = await fetch("/data.json");
          const jsonData = await response.json();
          setData(jsonData.Views[6]);
        }
        fetchData();
    }, []);
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center">
                            <Link to="/inondations_d"><img src={FR} className="flag_icon mr-3 active_lang" /></Link>
                        </div>
                    </div>
                    </Link>
                ...
                <div className="col-md-8">
                    ...
                    <div className="tab-content pt-2">
                        ...
                        <h5>Inondation de la rivière Aude <img src={FR} className="flag_icon" /></h5>
                        <small className="text-muted">Inondation de la rivière Aude - Total View</small>
                        </div>
                        ...
                        <div className="tab-pane fade" id="edits" role="tabpanel">
                            <img src={InondationsDChart} width="700px" height="400px" />
                        </div>
                    </div>
                    </div>
                </div>
