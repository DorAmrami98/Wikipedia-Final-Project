...
import AquilaEarthquakeChart from "../charts_edits/2009_L'Aquila_earthquake.png";
...
function Aquila_earthquake_it() {
    ...
    useEffect(() => {
        async function fetchData() {
          ...
          setDataUS(jsonData.Views[0]);
          setDataIT(jsonData.Views[1]);
        }
        fetchData();
    }, []);
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        <h5>Terremoto dell'Aquila del 2009</h5>
                        <div className="d-flex justify-content-center">
                            <Link to="/general"><img src={US} className="flag_icon mr-3" /></Link>
                            <Link to="/aquila_earthquake_it"><img src={IT} className="flag_icon active_lang" /></Link>
                        </div>
                    </div>
                    </Link>
                    ...
                    <div className="card card-body text-center mb-2">
                        ...
                        <div className="d-flex justify-content-center">
                            ...
                            <Link to="/covid_19_pandemic_it"><img src={IT} className="flag_icon" /></Link><Link to="/covid_19_pandemic_sa"><img src={SA} className="flag_icon ml-3" /></Link>
                        </div>
                    </div>
                    </Link>
                ...
                <div className="col-md-8">
                    ...
                    <div className="tab-content pt-2">
                        ...
                        <h5>Terremoto dell'Aquila del 2009 <img src={IT} className="flag_icon" /></h5>
                        <small className="text-muted">Terremoto dell'Aquila del 2009 - Total View</small>
                        </div>
                        ...
                        <div className="tab-pane fade" id="edits" role="tabpanel">
                            <img src={AquilaEarthquakeChart} width="700px" height="400px" />
                        </div>
...
export default Aquila_earthquake_it;