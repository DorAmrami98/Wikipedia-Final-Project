...
function COVID_19_pandemic_sa() {
    ...
    for (let key in dataSA) {
        if (dataUS.hasOwnProperty(key) && dataDE.hasOwnProperty(key) && dataFR.hasOwnProperty(key) && dataIT.hasOwnProperty(key) && dataCN.hasOwnProperty(key)) {
            mergedData.push({
                date: key,
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center">
                            ...
                            <Link to="/covid_19_pandemic_sa"><img src={SA} className="flag_icon ml-3 active_lang" /></Link>
                        </div>
                    </div>
                    </Link>
                ...
                <div className="col-md-8">
                    ...
                    <div className="tab-content pt-2">
                        ...
                        <h5>جائحة_فيروس_كورونا <img src={SA} className="flag_icon" /></h5>
                        <small className="text-muted">جائحة_فيروس_كورونا - Total View</small>
                        </div>
...
export default COVID_19_pandemic_sa;