            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center">
                            <Link to="/european_floods_en"><img src={US} className="flag_icon mr-3 active_lang" /></Link>
                ...
                <div className="col-md-8">
                    ...
                    <div className="tab-content pt-2">
                        ...
                        <h5>2021 European Floods <img src={US} className="flag_icon" /></h5>
                        <small className="text-muted">2021 European Floods - Total View</small>
                        </div>
...
export default European_floods_en;