...
import ACCOVID19PandemicHR from "../../charts_auto_correlation/COVID-19_pandemic_hr.png";
...
function AC_COVID_19_pandemic_hr() {
    return (
        <>
        <Header />
            ...
            <div className="row">
                ...
                <div className="col-md-8">
                    <div className="card card-body pt-0">
                        <img src={ACCOVID19PandemicHR} width="700px" height="400px" />
                    </div>
                </div>
            </div>
        </div>
...
export default AC_COVID_19_pandemic_hr;