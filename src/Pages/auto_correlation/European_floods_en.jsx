...
import ACEuropeanFloodsEN from "../../charts_auto_correlation/2021_European_floods_en.png";
...
function AC_European_floods_en() {
    useEffect(() => {
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center">
                            <Link to="/auto-correlation-european-floods-en"><img src={US} className="flag_icon mr-3 active_lang" /></Link>
                ...
                <div className="col-md-8">
                    <div className="card card-body pt-0">
                        <img src={ACEuropeanFloodsEN} width="700px" height="400px" />
                    </div>
                </div>
            </div>
        </div>
...
export default AC_European_floods_en;