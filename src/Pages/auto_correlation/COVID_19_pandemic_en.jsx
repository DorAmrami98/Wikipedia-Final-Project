...
import ACCOVID19PandemicEN from "../../charts_auto_correlation/COVID-19_pandemic_en.png";
...
function AC_COVID_19_pandemic_en() {
    return (
        <>
        <Header />
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center">
                            <Link to="/auto-correlation-covid-19-pandemic-en"><img src={US} className="flag_icon active_lang" /></Link>
                ...
                <div className="col-md-8">
                    <div className="card card-body pt-0">
                        <img src={ACCOVID19PandemicEN} width="700px" height="400px" />
                    </div>
                </div>
            </div>
        </div>
...
export default AC_COVID_19_pandemic_en;