...
import ACVisakhapatnamGasLeakEN from "../../charts_auto_correlation/Visakhapatnam_gas_leak_en.png";
...
function AC_Visakhapatnam_gas_leak_en() {
    useEffect(() => {
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center">
                            <Link to="/auto-correlation-visakhapatnam-gas-leak-en"><img src={US} className="flag_icon mr-3 active_lang" /></Link>
                ...
                <div className="col-md-8">
                    <div className="card card-body pt-0">
                        <img src={ACVisakhapatnamGasLeakEN} width="700px" height="400px" />
                    </div>
                </div>
            </div>
        </div>
...
export default AC_Visakhapatnam_gas_leak_en;