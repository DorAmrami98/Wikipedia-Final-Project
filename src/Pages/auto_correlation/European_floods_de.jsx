...
import ACEuropeanFloodsDE from "../../charts_auto_correlation/2021_European_floods_de.png";
...
function AC_European_floods_de() {
    useEffect(() => {
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center">
                            ...
                            <Link to="/auto-correlation-european-floods-de"><img src={DE} className="flag_icon active_lang" /></Link>
                        </div>
                    </div>
                    </Link>
                </div>
                <div className="col-md-8">
                    <div className="card card-body pt-0">
                        <img src={ACEuropeanFloodsDE} width="700px" height="400px" />
                    </div>
                </div>
            </div>
        </div>
...
export default AC_European_floods_de;