...
import ACTohokuEarthquakeTsunamiEN from "../../charts_auto_correlation/2011_Tōhoku_earthquake_and_tsunami_en.png";
...
function AC_Tohoku_earthquake_and_tsunami_en() {
    useEffect(() => {
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2">
                        ...
                        <div className="d-flex justify-content-center">
                            ...
                            <Link to="/auto-correlation-covid-19-pandemic-de"><img src={DE} className="flag_icon mx-3" /></Link>
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center">
                            <Link to="/auto-correlation-tohoku-earthquake-tsunami-en"><img src={US} className="flag_icon mr-3 active_lang" /></Link>
                ...
                <div className="col-md-8">
                    <div className="card card-body pt-0">
                        <img src={ACTohokuEarthquakeTsunamiEN} width="700px" height="400px" />
                    </div>
                </div>
            </div>
        </div>
...
export default AC_Tohoku_earthquake_and_tsunami_en;