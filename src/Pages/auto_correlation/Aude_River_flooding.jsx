...
import ACAudeRiverFloodingIT from "../../charts_auto_correlation/Aude_River_flooding_fr.png";
...
function AC_Aude_River_flooding() {
    return (
        <>
        <Header />
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center">
                            <Link to="/auto-correlation-aude-river-flooding"><img src={FR} className="flag_icon active_lang" /></Link>
                        </div>
                    </div>
                    </Link>
                ...
                <div className="col-md-8">
                    <div className="card card-body pt-0">
                        <img src={ACAudeRiverFloodingIT} width="700px" height="400px" />
                    </div>
                </div>
            </div>
        </div>
...
export default AC_Aude_River_flooding;