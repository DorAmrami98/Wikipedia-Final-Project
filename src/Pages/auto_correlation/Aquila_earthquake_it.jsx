...
import ACAquilaEarthquakeIT from "../../charts_auto_correlation/2009_L'Aquila_earthquake_it.png";
...
function AC_Aquila_earthquake_it() {
    return (
        <>
        <Header />
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center">
                            ...
                            <Link to="/auto-correlation-aquila-earthquake-it"><img src={IT} className="flag_icon active_lang" /></Link>
                        </div>
                    </div>
                    </Link>
                ...
                <div className="col-md-8">
                    <div className="card card-body pt-0">
                        <img src={ACAquilaEarthquakeIT} width="700px" height="400px" />
                    </div>
                </div>
            </div>
        </div>
...
export default AC_Aquila_earthquake_it;