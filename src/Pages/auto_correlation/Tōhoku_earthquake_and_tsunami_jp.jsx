...
import ACTohokuEarthquakeTsunamiJP from "../../charts_auto_correlation/2011_Tōhoku_earthquake_and_tsunami_ja.png";
...
function AC_Tohoku_earthquake_and_tsunami_jp() {
    useEffect(() => {
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center">
                            ...
                            <Link to="/auto-correlation-tohoku-earthquake-tsunami-jp"><img src={JP} className="flag_icon active_lang" /></Link>
                        </div>
                    </div>
                    </Link>
                ...
                <div className="col-md-8">
                    <div className="card card-body pt-0">
                        <img src={ACTohokuEarthquakeTsunamiJP} width="700px" height="400px" />
                    </div>
                </div>
            </div>
        </div>
...
export default AC_Tohoku_earthquake_and_tsunami_jp;