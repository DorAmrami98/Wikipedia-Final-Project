...
import ACManchesterArenaBombingEN from "../../charts_auto_correlation/Manchester_Arena_bombing_en.png";
...
function AC_Manchester_Arena_bombing_en() {
    return (
        <>
        <Header />
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center">
                            <Link to="/auto-correlation-manchester-arena-bombing-en"><img src={US} className="flag_icon mr-3 active_lang" /></Link>
                ...
                <div className="col-md-8">
                    <div className="card card-body pt-0">
                        <img src={ACManchesterArenaBombingEN} width="700px" height="400px" />
                    </div>
                </div>
            </div>
        </div>
...
export default AC_Manchester_Arena_bombing_en;