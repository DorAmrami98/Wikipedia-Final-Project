...
import ACManchesterArenaBombingSA from "../../charts_auto_correlation/Manchester_Arena_bombing_ar.png";
...
function AC_Manchester_Arena_bombing_sa() {
    return (
        <>
        <Header />
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center">
                            ...
                            <Link to="/auto-correlation-manchester-arena-bombing-sa"><img src={SA} className="flag_icon active_lang" /></Link>
                        </div>
                    </div>
                    </Link>
                ...
                <div className="col-md-8">
                    <div className="card card-body pt-0">
                        <img src={ACManchesterArenaBombingSA} width="700px" height="400px" />
                    </div>
                </div>
            </div>
        </div>
...
export default AC_Manchester_Arena_bombing_sa;