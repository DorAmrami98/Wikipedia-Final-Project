...
import TohokuEarthquakeAndTsunamiChart from "../charts_edits/2011_Tōhoku_earthquake_and_tsunami.png";
...
function Tohoku_earthquake_and_tsunami_jp() {
    ...
    useEffect(() => {
        async function fetchData() {
          ...
          setDataUS(jsonData.Views[7]);
          setDataJP(jsonData.Views[8]);
        }
        fetchData();
    }, []);
    const chartData = Object.entries(dataJP).map(([date, value]) => ({date, value}));
    let mergedData = [];
    for (let key in dataJP) {
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center">
                            ...
                            <Link to="/tohoku_earthquake_and_tsunami_jp"><img src={JP} className="flag_icon active_lang" /></Link>
                        </div>
                    </div>
                    </Link>
                ...
                <div className="col-md-8">
                    ...
                    <div className="tab-content pt-2">
                        ...
                        <h5>東北地方太平洋沖地震 <img src={JP} className="flag_icon" /></h5>
                        <small className="text-muted">東北地方太平洋沖地震 - Total View</small>
                        </div>
                        ...
                        <div className="tab-pane fade" id="edits" role="tabpanel">
                            <img src={TohokuEarthquakeAndTsunamiChart} width="700px" height="400px" />
                        </div>
                        <div className="tab-pane fade" id="comparison" role="tabpanel">
                            <LineChart width={700} height={400} data={mergedData}>
                                ...
                                <Line type="monotone" dataKey="Japan" stroke="#d30000" activeDot={{ r: 8 }} />
                            </LineChart>
                        </div>
                    </div>
                    </div>
...
export default Tohoku_earthquake_and_tsunami_jp;