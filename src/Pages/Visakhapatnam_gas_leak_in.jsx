...
function Visakhapatnam_gas_leak_in() {
    ...
    const chartData = Object.entries(dataIN).map(([date, value]) => ({date, value}));
    let mergedData = [];
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center">
                            ...
                            <Link to="/visakhapatnam_gas_leak_in"><img src={IN} className="flag_icon active_lang" /></Link>
                        </div>
                    </div>
                    </Link>
                ...
                <div className="col-md-8">
                    ...
                    <div className="tab-content pt-2">
                        ...
                        <h5>विशाखपट्नम गैस रिसाव <img src={IN} className="flag_icon" /></h5>
                        <small className="text-muted">विशाखपट्नम गैस रिसाव - Total View</small>
                        </div>
...
export default Visakhapatnam_gas_leak_in;