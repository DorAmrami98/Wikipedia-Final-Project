...
function COVID_19_pandemic_cn() {
    ...
    const chartData = Object.entries(dataCN).map(([date, value]) => ({date, value}));
    let mergedData = [];
    for (let key in dataCN) {
        if (dataUS.hasOwnProperty(key) && dataDE.hasOwnProperty(key) && dataIT.hasOwnProperty(key) && dataFR.hasOwnProperty(key) && dataSA.hasOwnProperty(key)) {
            mergedData.push({
                date: key,
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center">
                            ...
                            <Link to="/covid_19_pandemic_cn"><img src={CN} className="flag_icon mx-3 active_lang" /></Link>
                ...
                <div className="col-md-8">
                    ...
                    <div className="tab-content pt-2">
                        ...
                        <h5>2019冠状病毒病疫情 <img src={CN} className="flag_icon" /></h5>
                        <small className="text-muted">2019冠状病毒病疫情 - Total View</small>
                        </div>
...
export default COVID_19_pandemic_cn;