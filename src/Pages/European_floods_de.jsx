...
import EuropeanFloodsChart from "../charts_edits/2021_European_floods.png";
...
function European_floods_de() {
    ...
    useEffect(() => {
        async function fetchData() {
          ...
          setDataUS(jsonData.Views[15]);
          setDataDE(jsonData.Views[14]);
        }
        fetchData();
    }, []);
    const chartData = Object.entries(dataDE).map(([date, value]) => ({date, value}));
    let mergedData = [];
    for (let key in dataDE) {
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        <h5>Hochwasser in West-und Mitteleuropa 2021</h5>
                        <div className="d-flex justify-content-center">
                            <Link to="/european_floods_en"><img src={US} className="flag_icon mr-3" /></Link>
                            <Link to="/european_floods_de"><img src={DE} className="flag_icon active_lang" /></Link>
                        </div>
                    </div>
                    </Link>
                </div>
                <div className="col-md-8">
                    ...
                    <div className="tab-content pt-2">
                        ...
                        <h5>Hochwasser in West-und Mitteleuropa 2021 <img src={DE} className="flag_icon" /></h5>
                        <small className="text-muted">Hochwasser in West-und Mitteleuropa 2021 - Total View</small>
                        </div>
                        ...
                        <div className="tab-pane fade" id="edits" role="tabpanel">
                            <img src={EuropeanFloodsChart} width="700px" height="400px" />
                        </div>
                        <div className="tab-pane fade" id="comparison" role="tabpanel">
                            <LineChart width={700} height={400} data={mergedData}>
                                ...
                                <Line type="monotone" dataKey="Germany" stroke="#dd0000" activeDot={{ r: 8 }} />
                            </LineChart>
                        </div>
                    </div>
                    </div>
...
export default European_floods_de;