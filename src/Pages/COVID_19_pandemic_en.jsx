...
function COVID_19_pandemic_en() {
    ...
    for (let key in dataUS) {
        if (dataFR.hasOwnProperty(key) && dataDE.hasOwnProperty(key) && dataIT.hasOwnProperty(key) && dataCN.hasOwnProperty(key) && dataSA.hasOwnProperty(key)) {
            mergedData.push({
                date: key,
            ...
            <div className="row">
                <div className="col-md-4 sidebar">
                    ...
                    <div className="card card-body text-center mb-2 active_card_lang">
                        ...
                        <div className="d-flex justify-content-center">
                            <Link to="/covid_19_pandemic_en"><img src={US} className="flag_icon active_lang" /></Link>
                ...
                <div className="col-md-8">
                    ...
                    <div className="tab-content pt-2">
                        ...
                        <h5>COVID-19 Pandemic <img src={US} className="flag_icon" /></h5>
                        <small className="text-muted">COVID-19 Pandemic - Total View</small>
                        </div>
...
export default COVID_19_pandemic_en;